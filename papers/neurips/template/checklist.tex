...
\item {\bf Experiment statistical significance}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Appendix~\ref{app:seeds} reports a 3-seed stability check for the two primary neural models (shared-only and SP~$d_\mathrm{priv}\!=\!16$), including per-seed metrics, means, and standard deviations.  The ordering is consistent across all seeds.  We do not claim formal statistical significance; the seed check demonstrates ordering stability, not a hypothesis test.
